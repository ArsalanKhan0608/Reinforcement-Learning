...
class MazeEnv(gym.Env):
    ...
    #             reward += max(0, 5 - distance_to_goal)  
    ...
    #     # Track and penalize consecutive invalid steps
    #     if valid_step:
    #         self.invalid_step_count = 0
    #     else:
    #         self.invalid_step_count += 1
    #         if self.invalid_step_count >= 3:
    #             reward -= 2  # Additional penalty for 3 consecutive invalid steps
