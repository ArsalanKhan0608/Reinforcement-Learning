...
class ModifiedMazeGameEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # Apply a small negative reward for an invalid move or if the agent stays in the same position
        reward = -0.1 if not valid_move or np.array_equal(self.current_pos, new_pos) else 0
