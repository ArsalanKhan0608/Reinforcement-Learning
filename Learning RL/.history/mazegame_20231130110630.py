...
class MazeGameEnv(gym.Env):
    ...
    def step(self,action):
        ...
        new_pos = np.array(self.current_pos[0]).reshape(1, -1)
        print("New Position in Step index values [0,0]:", new_pos[0,0])
        print("New Position in Step without index values:", new_pos)
