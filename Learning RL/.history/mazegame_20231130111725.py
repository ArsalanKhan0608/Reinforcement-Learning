...
class MazeGameEnv(gym.Env):
    def __init__(self,maze):
        ...
        print("Current Position in 1D using index ",np.array(self.current_pos, dtype=np.int32).flatten())
        print("Current Position in 1D using index [0,0]",np.array(self.current_pos, dtype=np.int32).flatten()[0,0])
