...
model = DQN('MlpPolicy', env, verbose=1, learning_rate=0.0005, gamma=0.99, buffer_size=50000, exploration_fraction=0.1, exploration_initial_eps=1.0, exploration_final_eps=0.02)
