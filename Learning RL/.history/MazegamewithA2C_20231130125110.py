...
model = A2C('MlpPolicy', env, verbose=1,
            ...
            max_grad_norm=0.7,  # the maximum value for the gradient clipping
            use_rms_prop=True,  # using RMSprop optimizer (if False, uses Adam optimizer)
            ...
            policy_kwargs=dict(net_arch=[128, 128]))  # size of the neural network for the policy
